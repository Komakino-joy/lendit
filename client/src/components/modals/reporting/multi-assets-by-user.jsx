...
import { httpFetchMultiAssetsByUser } from "../../../services/api";
...
const MultipleAssetsByUser = () => {
  ...
  useEffect(() => {
    const fetchData = async (memberId) => {
      setData(await httpFetchMultiAssetsByUser(memberId));
    };
    fetchData(memberId);
  }, [memberId]);
...
export default MultipleAssetsByUser;
