...
import backgroundImage from '../src/images/background.webp';
        ...
        <ErrorBoundary>
          ...
          >
            <Route exact path='/signin'>
              {isSignedIn ? <Redirect to='/home' /> : <SigninPage />}
            </Route>
            <Route exact path='/register'>
              {isSignedIn ? <Redirect to='/home' /> : <RegistrationPage />}
            </Route>
            <Route
              exact
              path='/'
              render={() =>
                isSignedIn ? <Redirect to='/home' /> : <Redirect to='/signin' />
              }
            />
